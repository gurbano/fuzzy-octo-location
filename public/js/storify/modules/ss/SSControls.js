...
SSControls.prototype.start = function() {
    ...
    if (havePointerLock) {
        document.addEventListener('pointerlockchange', function(){self.pointerlockchange(self)}, false);
        document.addEventListener('mozpointerlockchange', function(){self.pointerlockchange(self)}, false);
        document.addEventListener('webkitpointerlockchange', function(){self.pointerlockchange(self)}, false);
...
SSControls.prototype.requestPointerLock = function() {
    ...
    if (/Firefox/i.test(navigator.userAgent)) {
        document.addEventListener('fullscreenchange', function(){self.fullscreenchange(self)}, false);
        document.addEventListener('mozfullscreenchange', function(){self.fullscreenchange(self)}, false);
